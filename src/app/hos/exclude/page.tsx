  ...
  return (
    <>
      <PageHead
        ...
        desc="เมื่อเคสที่ระบบมอบหมายมาไม่ใช่พื้นที่รับผิดชอบของ รพ.บางกระทุ่ม ให้ยื่นคำร้องพร้อมหลักฐานต่อ Admin จังหวัด"
        actions={
          <>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
        <div className="flex flex-col gap-4 min-w-0">
          ...
          >
            <div className="scroll-x nice">
              <table className="w-full border-collapse min-w-[720px]">
                ...
                <tbody>
                  {[
                    ["PLK-6809-0138", "อนุชิต แซ่ลิ้ม", "ไข้เลือดออก", "88/2 ม.2 ต.บางกระทุ่ม", "26 ส.ค. 2569", true],
                    ["PLK-6809-0142", "กฤษฎา พรมเรือง", "ไข้เลือดออก", "128/4 ม.4 ต.บางกระทุ่ม", "27 ส.ค. 2569", false],
                    ["PLK-6809-0131", "ด.ญ.พิมพ์ลภัส จันแดง", "มือ เท้า ปาก", "19 ม.7 ต.โคกสลุด", "24 ส.ค. 2569", false],
                  ].map(([id, n, d, a, dt, sel]) => (
                    <tr
                      key={String(id)}
          ...
          <Card title="ขั้นตอนที่ 3 · ที่อยู่จริงและหน่วยบริการที่ควรรับผิดชอบ" icon="pin">
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="ที่อยู่ตามที่ระบบระบุ" value="88/2 ม.2 ต.บางกระทุ่ม อ.บางกระทุ่ม" wide />
              ...
              <div>
                ...
                <select className="inp" defaultValue="aran">
                  <option value="aran">หน่วยบริการเครือข่ายอรัญญิก</option>
                  <option value="huaro">หน่วยบริการเครือข่ายหัวรอ</option>
                  <option value="thathong">หน่วยบริการเครือข่ายท่าทอง</option>
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  readOnly
                  defaultValue="ลงพื้นที่ตรวจสอบบ้านเลขที่ 88/2 ม.2 เมื่อวันที่ 26 ส.ค. 2569 พบว่าเป็นบ้านของญาติ ผู้ป่วยย้ายไปพักอาศัยที่ ม.6 ต.อรัญญิก ตั้งแต่ ก.พ. 2569 อสม. ประจำหมู่บ้านยืนยันข้อมูลตรงกัน จึงขอตัดเคสออกและส่งต่อให้หน่วยบริการเครือข่ายอรัญญิกรับผิดชอบแทน"
                />
              </div>
            </div>
          </Card>
        ...
        <div className="flex flex-col gap-4 min-w-0">
          <Card title="สรุปคำร้องที่กำลังสร้าง" icon="clipboard">
            <dl className="grid gap-2.5 text-[12.5px]">
              {[
                ...
                ["ผู้ป่วย", "อนุชิต แซ่ลิ้ม"],
                ["เหตุผล", "ที่อยู่จริงไม่อยู่ในเขต"],
                ["ส่งต่อให้", "หน่วยบริการเครือข่ายอรัญญิก"],
                ["หลักฐานแนบ", "3 รายการ"],
          ...
          <Card title="ประวัติคำร้องของ รพ.บางกระทุ่ม" icon="clock" pad={false}>
            <ul>
              {HISTORY.map((h) => (
