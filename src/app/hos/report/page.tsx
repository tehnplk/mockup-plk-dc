...
const SOURCES = [
  ...
  ["เจ้าหน้าที่ รพ.บางกระทุ่ม พบขณะเยี่ยมบ้าน", "พบระหว่างออกเยี่ยมบ้าน/คัดกรอง", false],
  ["ผู้ป่วยมารับบริการที่ รพ.บางกระทุ่ม", "มาตรวจที่โรงพยาบาลโดยตรง", false],
...
const SENT = [
  ...
  },
  {
    ...
    disease: "ไข้เลือดออก",
    color: "#dc2626",
    place: "ม.4 ต.บางกระทุ่ม",
    by: "เยี่ยมบ้านโดย จนท. รพ.บางกระทุ่ม",
    sent: "26 ส.ค. 14:40",
    team: "ทีม SRRT บางกระทุ่ม-1",
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
        <div className="flex flex-col gap-4 min-w-0">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  className="inp"
                  readOnly
                  defaultValue="19 หมู่ 7 ต.โคกสลุด อ.บางกระทุ่ม (ศูนย์เด็กเล็กชุมชน)"
                />
              </div>
              <div>
          ...
          >
            <div className="grid gap-2.5">
              {[
                ["ทีม SRRT บางกระทุ่ม-2", "รับผิดชอบ ม.5–ม.9 · ว่าง 2 เคส", "ออนไลน์", "#16a34a", true],
                ["ทีม SRRT บางกระทุ่ม-1", "รับผิดชอบ ม.1–ม.4 · ว่าง 1 เคส", "ออนไลน์", "#16a34a", false],
                ["ทีม CDCU จังหวัด", "สนับสนุนกรณีระบาดเป็นกลุ่มก้อน", "ออนไลน์", "#16a34a", false],
                ["ทีม รพ.บางกระทุ่ม ดำเนินการเอง", "บันทึกสอบสวนเองโดยไม่ส่งต่อ", "—", "#94a3b8", false],
              ].map(([n, d, s, c, on]) => (
                <label
                  key={String(n)}
