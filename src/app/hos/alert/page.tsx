...
const TARGETS = [
  {
    name: "กฤษฎา พรมเรือง",
    detail: "ชาย 34 ปี · ผู้ป่วยยืนยัน · ม.4 ต.บางกระทุ่ม",
    group: "ผู้ป่วยยืนยัน",
    bg: "#fee2e2",
    fg: "#b91c1c",
    line: true,
  ...
  },
  {
    ...
    detail: "หญิง 31 ปี · ผู้สัมผัสร่วมบ้าน · ม.4 ต.บางกระทุ่ม",
  ...
  },
  {
    ...
    detail: "ชาย 9 ปี · ผู้สัมผัสร่วมบ้าน · ม.4 ต.บางกระทุ่ม",
    group: "ผู้สัมผัสร่วมบ้าน",
    bg: "#ffedd5",
    fg: "#c2410c",
    line: false,
  ...
  {
    name: "บุญมา แสงทอง",
    detail: "หญิง 66 ปี · กลุ่มเสี่ยงรัศมี 100 ม. · ม.4 ต.บางกระทุ่ม",
    group: "รัศมี 100 ม.",
    bg: "#fef3c7",
    fg: "#b45309",
    line: true,
