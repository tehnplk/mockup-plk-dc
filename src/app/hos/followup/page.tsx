          ...
          <Card title="ช่องทางที่ประชาชนตอบกลับ" icon="chat">
            <div className="grid gap-3">
              {[
                ...
                ["โทรศัพท์ รพ.บางกระทุ่ม", 8, "#2563eb"],
                ["อื่นๆ", 3, "#94a3b8"],
              ].map(([l, v, c]) => (
                <div key={String(l)}>
      ...
      <div className="grid gap-4 xl:grid-cols-3 mb-5">
        ...
        >
          <BarChart
            ...
            keys={["a", "b", "c"]}
            labels={["ม.4 ต.บางกระทุ่ม", "ม.2 ต.สนามคลี", "ค่าเฉลี่ยพื้นที่"]}
          />
        </Card>
      ...
      >
        <div className="scroll-x nice">
          <table className="w-full border-collapse min-w-[780px]">
            ...
            <tbody>
              {[
                ["บ้านเลขที่ 128/4", "ม.4 ต.บางกระทุ่ม", "นางสมพร ดีใจ", "พบลูกน้ำ 3 จุด", 28, "ต้องเยี่ยมซ้ำ", "#fee2e2", "#b91c1c"],
                ["บ้านเลขที่ 96/1", "ม.4 ต.บางกระทุ่ม", "นางสมพร ดีใจ", "พบลูกน้ำ 2 จุด", 36, "ต้องเยี่ยมซ้ำ", "#fee2e2", "#b91c1c"],
                ["บ้านเลขที่ 44", "ม.2 ต.สนามคลี", "นายบุญมา ทองแท้", "พบลูกน้ำ 1 จุด", 52, "เฝ้าระวัง", "#fef3c7", "#b45309"],
                ["บ้านเลขที่ 210/8", "ม.2 ต.สนามคลี", "นายบุญมา ทองแท้", "ไม่ตอบแบบสำรวจ", 0, "ยังไม่ประเมิน", "#f1f5f9", "#475569"],
