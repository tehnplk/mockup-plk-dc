    ...
    <>
      ...
      <div className="grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)]">
        ...
        >
          <ul>
            {[
              ["69082702", "กฤษฎา พรมเรือง", "ไข้เลือดออก", "ม.4", 68, true, "#dc2626"],
              ["69082603", "อนุชิต แซ่ลิ้ม", "ไข้เลือดออก", "ม.2", 34, false, "#dc2626"],
              ["69082406", "ด.ญ.พิมพ์ลภัส จันแดง", "มือ เท้า ปาก", "ม.7", 100, false, "#059669"],
              ["69082502", "สุทัศน์ มากมี", "ไข้หวัดใหญ่", "ม.1", 100, false, "#2563eb"],
              ["69082403", "อรวรรณ ปั้นทอง", "ไข้เลือดออก", "ม.4", 100, false, "#dc2626"],
