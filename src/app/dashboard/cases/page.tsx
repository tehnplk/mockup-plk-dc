...
const TIMELINE = [
  ["โรงพยาบาลแจ้งเคส", "27 ส.ค. 08:14", "รพ.บางกระทุ่ม", true],
  ["Push เข้า Dashboard กลาง", "27 ส.ค. 08:47", "ระบบอัตโนมัติ", true],
  ["ส่ง Flex แจ้งทีม 5 คน", "27 ส.ค. 09:12", "ระบบอัตโนมัติ", true],
  ["ทีมกดรับเคส", "27 ส.ค. 09:31", "ทีม SRRT บางกระทุ่ม-1", true],
  ["ลงพื้นที่สอบสวน", "27 ส.ค. 10:09", "ทีม SRRT บางกระทุ่ม-1", true],
          ...
          <Card title="ผู้เกี่ยวข้องกับเคสนี้" icon="users">
            <div className="grid gap-2.5">
              {[
                ...
                ["นายกิตติศักดิ์ แสงเพชร", "ผู้สอบสวน · ทีม SRRT บางกระทุ่ม-1"],
                ["นายวิรัตน์ สุขเกษม", "ผู้ประสานพื้นที่ · รพ.บางกระทุ่ม"],
