...
const DECIDED = [
  ["REQ-6809-011", "พิมพ์ใจ ศรีนวล", "รพ.สต.บ้านคลอง", "อนุมัติ", "22 ส.ค.", "#dcfce7", "#15803d"],
  ["REQ-6809-010", "ชูชาติ ทวีทรัพย์", "รพ.สต.หัวรอ", "อนุมัติ", "21 ส.ค.", "#dcfce7", "#15803d"],
  ["REQ-6809-009", "มะลิวัลย์ พุ่มพวง", "รพ.สต.ท่าโพธิ์", "ไม่อนุมัติ", "20 ส.ค.", "#fee2e2", "#b91c1c"],
  ["REQ-6809-008", "สุรชัย พันธ์ทอง", "รพ.สต.บ้านคลอง", "อนุมัติ", "18 ส.ค.", "#dcfce7", "#15803d"],
  ["REQ-6809-007", "เพ็ญศรี มีสุข", "รพ.สต.บึงพระ", "อนุมัติ", "16 ส.ค.", "#dcfce7", "#15803d"],
];
        ...
        <div className="grid gap-4 content-start">
          ...
          <Card title="บันทึกการพิจารณา" icon="clipboard">
            ...
            <div className="flex items-center gap-2 mt-3">
              <Avatar name="นพ.ธนากร วงศ์วิวัฒน์" size={26} />
              <span className="text-[11.5px] text-muted">
                ผู้พิจารณา: นพ.ธนากร วงศ์วิวัฒน์
              </span>
            </div>
          </Card>
