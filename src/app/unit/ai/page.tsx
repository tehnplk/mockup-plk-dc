        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[13.5px] leading-relaxed mt-2 text-ink">
              ...
              <mark className="bg-[#fde68a] px-1 rounded"> ม.4 ต.บางกระทุ่ม </mark>
      ...
      <div className="grid gap-4 xl:grid-cols-3 mb-5">
        ...
        >
          <div className="grid gap-3">
            {[
              [
                "เร่งกำจัดแหล่งเพาะพันธุ์ ม.4 ต.บางกระทุ่ม ภายใน 3 วัน",
        ...
        <div className="flex flex-col gap-4 min-w-0">
          ...
          <Card title="ถามข้อมูลด้วยภาษาธรรมชาติ" icon="chat">
            ...
            >
              ม.4 ต.บางกระทุ่ม เพิ่มขึ้น 200% (2 → 6 ราย) รองลงมาคือ ม.2 ต.สนามคลี 100% (2 → 4 ราย)
            ...
            <div className="flex items-center gap-2 mt-3 h-10 px-3 rounded-xl border border-line-brd">
              <input
                ...
                placeholder="พิมพ์คำถามเกี่ยวกับข้อมูลในพื้นที่ รพ.บางกระทุ่ม…"
                readOnly
              />
      ...
      >
        <div className="scroll-x nice">
          <table className="w-full border-collapse min-w-[820px]">
            ...
            <tbody>
              {[
                ["ม.4 ต.บางกระทุ่ม", 6, 62.4, "24.1%", "9.8%", 1.58, "2–3 ราย", 92],
                ["ม.2 ต.สนามคลี", 4, 48.1, "18.6%", "7.6%", 1.41, "1–2 ราย", 81],
                ["ม.7 บ้านท่าโรง", 2, 34.2, "12.4%", "5.2%", 1.16, "0–2 ราย", 64],
                ["ม.1 ต.ไผ่ล้อม", 1, 26.8, "9.2%", "4.4%", 1.04, "0–1 ราย", 51],
