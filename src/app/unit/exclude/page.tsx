          ...
          >
            <div className="scroll-x nice">
              <table className="w-full border-collapse min-w-[720px]">
                ...
                <tbody>
                  {[
                    ["PLK-6809-0138", "อนุชิต แซ่ลิ้ม", "ไข้เลือดออก", "88/2 ม.2 ต.บ้านคลอง", "26 ส.ค. 2569", true],
                    ["PLK-6809-0142", "กฤษฎา พรมเรือง", "ไข้เลือดออก", "128/4 ม.4 ต.บ้านคลอง", "27 ส.ค. 2569", false],
                    ["PLK-6809-0131", "ด.ญ.พิมพ์ลภัส จันแดง", "มือ เท้า ปาก", "19 ม.7 ต.บ้านคลอง", "24 ส.ค. 2569", false],
                  ].map(([id, n, d, a, dt, sel]) => (
                    <tr
                      key={String(id)}
