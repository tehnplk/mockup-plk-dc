  ...
  return (
    <>
      <PageHead
        ...
        desc="บันทึกแบบสอบสวนของเคสที่หน่วยบริการรับผิดชอบ · เจ้าหน้าที่หน่วยบริการบันทึกเองได้โดยไม่ต้องรอทีม SRRT/CDCU"
        actions={
          <>
      ...
      <div className="grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)]">
        ...
        >
          <ul>
            {[
              ["PLK-6809-0142", "กฤษฎา พรมเรือง", "ไข้เลือดออก", "ม.4", 68, true, "#dc2626"],
              ["PLK-6809-0138", "อนุชิต แซ่ลิ้ม", "ไข้เลือดออก", "ม.2", 34, false, "#dc2626"],
              ["PLK-6809-0131", "ด.ญ.พิมพ์ลภัส จันแดง", "มือ เท้า ปาก", "ม.7", 100, false, "#059669"],
              ["PLK-6809-0126", "สุทัศน์ มากมี", "ไข้หวัดใหญ่", "ม.1", 100, false, "#2563eb"],
              ["PLK-6809-0119", "อรวรรณ ปั้นทอง", "ไข้เลือดออก", "ม.4", 100, false, "#dc2626"],
        ...
        <div className="flex flex-col gap-4 min-w-0">
          ...
          >
            ...
            <Link href="/unit/exclude" className="btn btn-sm">
          ...
          <Card title="ส่วนที่ 3 · ผู้สัมผัสใกล้ชิดในเขต" icon="users" pad={false}>
            <div className="scroll-x nice">
              <table className="w-full border-collapse min-w-[620px]">
                ...
                <tbody>
                  {[
                    ["นางพัชรินทร์ พรมเรือง", "ภรรยา", "ไม่มีอาการ", "36.8 °C", "เฝ้าระวัง 14 วัน", "#dcfce7", "#15803d"],
                    ["ด.ช.ณฐกร พรมเรือง", "บุตร", "มีไข้ 37.9 °C", "37.9 °C", "ส่งพบแพทย์", "#fee2e2", "#b91c1c"],
                    ["นายเอกพงศ์ สุขเนตร", "เพื่อนร่วมงาน", "มีไข้ 2 วัน", "38.4 °C", "ส่งพบแพทย์", "#fee2e2", "#b91c1c"],
                    ["นางทัศนีย์ ทองก้อน", "เพื่อนบ้าน ม.4", "ไม่มีอาการ", "36.5 °C", "เฝ้าระวัง 14 วัน", "#dcfce7", "#15803d"],
                  ].map(([n, r, s, t, a, bg, fg]) => (
