  ...
  return (
    <>
      <PageHead
        ...
        desc="รพ.สต.บ้านคลอง · ต.บ้านคลอง อ.เมืองพิษณุโลก · 9 หมู่บ้าน · ประชากร 8,742 คน · เชื่อมต่อ HIS: HOSxP PCU (ปกติ)"
        actions={
          <>
        ...
        <Card title="ทางลัดระบบงาน" icon="grid">
          <div className="grid gap-2">
            {[
              ...
              ["/unit/analytics", "chart", "วิเคราะห์ข้อมูลพื้นที่", "แนวโน้มและผลการดำเนินงาน"],
              ["/unit/ai", "sparkles", "Assistant ด้วย AI", "พยากรณ์และข้อเสนอแนะ"],
