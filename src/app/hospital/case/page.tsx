      ...
      <PageHead
        ...
        actions={
          <>
            ...
            <Link href="/hospital/push" className="btn btn-primary btn-sm">
        ...
        <div className="grid gap-4 content-start">
          ...
          <Card title="เครื่องมือช่วยกรอก" icon="sparkles">
            <div className="grid gap-2">
              <Link href="/hospital/voice" className="btn justify-start">
                <Icon name="mic" size={16} /> สรุปสนทนาผู้ป่วยด้วยเสียง
              </Link>
              <Link href="/hospital/documents" className="btn justify-start">
