  ...
  return (
    <>
      <PageHead
        ...
        desc="ผลการติดตามการดูแลตนเองของประชาชนในเขต รพ.สต.บ้านคลอง ผ่านแบบสำรวจบนไลน์หมอพร้อมและการเยี่ยมบ้านของ อสม."
        actions={
          <>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4 mb-5">
        <Stat label="ผู้ตอบแบบสำรวจ" value="512" unit="คน" icon="users" delta={-14} />
        ...
        <Stat label="ครัวเรือนที่ อสม. เยี่ยมแล้ว" value="186" unit="/ 260 หลัง" icon="home" tone="var(--ok)" />
      </div>

      <div className="grid gap-4 xl:grid-cols-[1fr_380px] mb-5">
        <Card
          title="พฤติกรรมการดูแลตนเองของประชาชน"
          desc="เปรียบเทียบก่อนและหลังการแจ้งข่าวผ่านไลน์หมอพร้อม รอบ 24 ส.ค. 2569 · เฉพาะหมู่บ้านที่มีการระบาด"
          icon="heart"
        >
        ...
        <div className="grid gap-4 content-start">
          <Card title="ระดับความเสี่ยงของครัวเรือน" icon="home">
            <Donut
              ...
              centerSub="ครัวเรือน"
              slices={[
                { label: "ปลอดภัย (ไม่พบลูกน้ำ)", value: 142, color: "#16a34a" },
                { label: "เฝ้าระวัง (พบ 1 จุด)", value: 68, color: "#f59e0b" },
                { label: "เสี่ยงสูง (พบ 2 จุดขึ้นไป)", value: 32, color: "#dc2626" },
                { label: "ยังไม่ได้สำรวจ", value: 18, color: "#cbd5e1" },
              ]}
            />
          </Card>
          ...
          <Card title="ช่องทางที่ประชาชนตอบกลับ" icon="chat">
            <div className="grid gap-3">
              {[
                ...
                ["โทรศัพท์ รพ.สต.บ้านคลอง", 8, "#2563eb"],
                ["อื่นๆ", 3, "#94a3b8"],
              ].map(([l, v, c]) => (
                <div key={String(l)}>
      ...
      <div className="grid gap-4 xl:grid-cols-3 mb-5">
        <Card
          ...
          desc="คะแนนรวมจากแบบประเมิน 10 ข้อ เต็ม 100 คะแนน · รายหมู่บ้าน"
          icon="chart"
        >
          <BarChart
            height={190}
            ...
            keys={["a", "b", "c"]}
            labels={["ม.4 บ้านคลองใหม่", "ม.2 บ้านคลองเหนือ", "ค่าเฉลี่ยตำบล"]}
          />
        </Card>
        ...
        <Card title="แบบสำรวจที่กำลังใช้งาน" icon="clipboard" pad={false}>
          <ul>
            {[
              ["แบบประเมินพฤติกรรม 3 เก็บ", "ส่ง 1,840 · ตอบ 512", "กำลังเก็บข้อมูล", "#dbeafe", "#1d4ed8"],
              ["แบบสำรวจลูกน้ำในครัวเรือน", "ส่ง 260 · ตอบ 242", "ใกล้ครบกำหนด", "#fef3c7", "#b45309"],
              ["แบบติดตามอาการหลังป่วย 14 วัน", "ส่ง 14 · ตอบ 12", "กำลังเก็บข้อมูล", "#dbeafe", "#1d4ed8"],
              ["แบบประเมินความพึงพอใจการแจ้งข่าว", "ส่ง 1,840 · ตอบ 304", "ปิดรับแล้ว", "#dcfce7", "#15803d"],
            ].map(([n, s, st, bg, fg]) => (
      ...
      >
        <div className="scroll-x nice">
          <table className="w-full border-collapse min-w-[780px]">
            ...
            <tbody>
              {[
                ["บ้านเลขที่ 128/4", "ม.4 บ้านคลองใหม่", "นางสมพร ดีใจ", "พบลูกน้ำ 3 จุด", 28, "ต้องเยี่ยมซ้ำ", "#fee2e2", "#b91c1c"],
                ["บ้านเลขที่ 96/1", "ม.4 บ้านคลองใหม่", "นางสมพร ดีใจ", "พบลูกน้ำ 2 จุด", 36, "ต้องเยี่ยมซ้ำ", "#fee2e2", "#b91c1c"],
                ["บ้านเลขที่ 44", "ม.2 บ้านคลองเหนือ", "นายบุญมา ทองแท้", "พบลูกน้ำ 1 จุด", 52, "เฝ้าระวัง", "#fef3c7", "#b45309"],
                ["บ้านเลขที่ 210/8", "ม.2 บ้านคลองเหนือ", "นายบุญมา ทองแท้", "ไม่ตอบแบบสำรวจ", 0, "ยังไม่ประเมิน", "#f1f5f9", "#475569"],
                ["บ้านเลขที่ 15", "ม.7 บ้านท่าโรง", "นางวันดี ศรีทอง", "ไม่พบลูกน้ำ", 84, "ปกติ", "#dcfce7", "#15803d"],
