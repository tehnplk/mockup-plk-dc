          ...
          >
            <div className="scroll-x nice">
              <table className="w-full border-collapse min-w-[720px]">
                ...
                <tbody>
                  {[
                    ["69082603", "อนุชิต แซ่ลิ้ม", "ไข้เลือดออก", "88/2 ม.2 ต.บางกระทุ่ม", "26 ส.ค. 2569", true],
                    ["69082702", "กฤษฎา พรมเรือง", "ไข้เลือดออก", "128/4 ม.4 ต.บางกระทุ่ม", "27 ส.ค. 2569", false],
                    ["69082406", "ด.ญ.พิมพ์ลภัส จันแดง", "มือ เท้า ปาก", "19 ม.7 ต.โคกสลุด", "24 ส.ค. 2569", false],
                  ].map(([id, n, d, a, dt, sel]) => (
                    <tr
                      key={String(id)}
