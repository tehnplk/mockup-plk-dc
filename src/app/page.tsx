    ...
    featureGroups: [
      {
        ...
        features: [
          { label: "Agent แจ้งเตือนตามรหัสโรค ICD-10 ที่กำหนด", href: "/hos/his-list" },
          { label: "ดึงข้อมูลอัตโนมัติจาก HIS และเติมข้อมูลส่วนที่ขาด", href: "/hos/case" },
          { label: "บันทึกข้อมูลสอบสวนโรค", href: "/hos/investigate" },
          { label: "แจ้งเคสด้วย Flex หมอพร้อมไปทีม SRRT/CDCU", href: "/hos/notify" },
          { label: "ทะเบียนแจ้งเคสและผลการตอบกลับ", href: "/hos/registry" },
        ],
      },
      {
        no: "2",
        ...
        features: [
          { label: "รับเคสจาก Dashboard กลาง หรือ Flex หมอพร้อม", href: "/area/inbox" },
          { label: "แจ้งเตือนประชาชนในพื้นที่ที่คัดเข้าผ่าน Flex หมอพร้อม", href: "/area/alert" },
        ],
      },
      {
        no: "3",
        ...
        features: [
          { label: "ยื่นคำร้องตัดเคสออกไปยัง สสจ.พิษณุโลก", href: "/area/exclude" },
          { label: "แผนที่การระบาด (GIS)", href: "/analysis/map" },
          { label: "ระบบวิเคราะห์ข้อมูลพื้นที่", href: "/analysis/analytics" },
          { label: "ระบบผลิตสื่อประชาสัมพันธ์", href: "/analysis/media" },
          { label: "แจ้งข่าวประชาชนในพื้นที่ระบาดผ่านไลน์หมอพร้อม", href: "/analysis/broadcast" },
          { label: "ติดตามพฤติกรรมสุขภาพและการดูแลตนเอง", href: "/analysis/followup" },
          { label: "จัดเก็บและค้นคืนเอกสารสอบสวนควบคุมโรค", href: "/analysis/documents" },
          { label: "Assistant ด้วย AI", href: "/analysis/ai" },
        ],
      },
    ],
  },
