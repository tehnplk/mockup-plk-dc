...
const MODULES: Module[] = [
  {
    ...
    featureGroups: [
      ...
      },
      {
        ...
        features: [
          { label: "รับเคสจาก Dashboard กลาง หรือ Flex หมอพร้อม", href: "/hos/inbox" },
          { label: "แจ้งเตือนประชาชนในพื้นที่ที่คัดเข้าผ่าน Flex หมอพร้อม", href: "/hos/alert" },
        ],
      },
      {
        no: "3",
        ...
        features: [
          { label: "ยื่นคำร้องตัดเคสออกไปยัง สสจ.พิษณุโลก", href: "/hos/exclude" },
          { label: "แผนที่การระบาด (GIS)", href: "/hos/map" },
          { label: "ระบบวิเคราะห์ข้อมูลพื้นที่", href: "/hos/analytics" },
          { label: "ระบบผลิตสื่อประชาสัมพันธ์", href: "/hos/media" },
          { label: "แจ้งข่าวประชาชนในพื้นที่ระบาดผ่านไลน์หมอพร้อม", href: "/hos/broadcast" },
          { label: "ติดตามพฤติกรรมสุขภาพและการดูแลตนเอง", href: "/hos/followup" },
          { label: "จัดเก็บและค้นคืนเอกสารสอบสวนควบคุมโรค", href: "/hos/documents" },
          { label: "Assistant ด้วย AI", href: "/hos/ai" },
        ],
      },
    ],
  },
